      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Budget Application List</h4>
                  <div class="">
                    <div class="dropdown text-right mb-2">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton3" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 31px, 0px); top: 0px; left: 0px; will-change: transform;">
                        ...
                        <a class="dropdown-item" href="<?=BASE_URL;?>/accountant/list">All</a>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/accountant/list?status=Approved">Status: Approved</a>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/accountant/list?status=Waiting">Status: Waiting</a>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/accountant/list?status=Rejected">Status: Reject</a>
                        <div class="dropdown-divider"></div>
                        <h6 class="dropdown-header">Budget Type</h6>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/accountant/list?type=OCAR">OCAR</a>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/accountant/list?type=BM">BM</a>
                        <div class="dropdown-divider"></div>
                        <h6 class="dropdown-header">GL Type</h6>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/accountant/list?GL=Asset">Asset</a>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/accountant/list?GL=Service">Service</a>
                      </div>
                    </div>
                            ...
                            <tr>
                              ...
                              <td class="text-right">
                                <div class="d-flex align-items-right">
                                  ...
                                  <a href="<?=BASE_URL;?>/accountant/edit?id=<?=$value->budget_id;?>" class="btn btn-success btn-sm btn-icon-text mr-3"><i class="typcn typcn-edit btn-icon-append"></i></a>
                                  <a href="<?=BASE_URL;?>/accountant/delete?id=<?=$value->budget_id;?>" class="btn btn-danger btn-sm btn-icon-text mr-3"><i class="typcn typcn-trash btn-icon-append"></i></a>
                                <?php endif; ?>
                                </div>
