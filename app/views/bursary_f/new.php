                  ...
                  <div class="">
                    <div class="dropdown text-right mb-2">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton3" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 31px, 0px); top: 0px; left: 0px; will-change: transform;">
                        ...
                        <a class="dropdown-item" href="<?=BASE_URL;?>/bursary/new">All</a>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/bursary/new?status=waiting">Status: Waiting</a>
                        <div class="dropdown-divider"></div>
                        <h6 class="dropdown-header">Budget Type</h6>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/bursary/new?type=OCAR">OCAR</a>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/bursary/new?type=BM">BM</a>
                        <div class="dropdown-divider"></div>
                        <h6 class="dropdown-header">GL Type</h6>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/bursary/new?GL=Asset">Asset</a>
                        <a class="dropdown-item" href="<?=BASE_URL;?>/bursary/new?GL=Service">Service</a>
                      </div>
                    </div>
                              ...
                              <tr>
                                ...
                                <td class="text-right">
                                  <div class="d-flex align-items-right">
                                    <?php if(empty($value->status_bursary)): ?>
