    ...
    <div class="main-panel">
      ...
      <form class="form-sample" action="<?=BASE_URL;?>/bursary/update" method="post">
        <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <select class="form-control" id="txt_status_bursary" name="txt_status_bursary">
                            <option value="">Please Select</option>
                    ...
                    <div class="col-md-8">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <textarea class="form-control" id="txt_remark_bursary" name="txt_remark_bursary" rows="4"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
